...
(
    ...
    PICTURE_ID1 NUMBER(4),
    PICTURE_ID2 NUMBER(4),
    PICTURE_ID3 NUMBER(4),
    PICTURE_ID4 NUMBER(4),
    PICTURE_ID5 NUMBER(4),
    PICTURE_ID6 NUMBER(4),
    PICTURE_ID7 NUMBER(4),
    PICTURE_ID8 NUMBER(4),
    PICTURE_ID9 NUMBER(4),
    PICTURE_ID10 NUMBER(4),
    UPDATED CHAR(1),         -- 'Y' or 'N'
    CROWDEDNESS1 NUMBER(1),
    CROWDEDNESS2 NUMBER(1),
    CROWDEDNESS3 NUMBER(1),
    CROWDEDNESS4 NUMBER(1),
    CROWDEDNESS5 NUMBER(1),
    CROWDEDNESS6 NUMBER(1),
    CROWDEDNESS7 NUMBER(1),
    CROWDEDNESS8 NUMBER(1),
    CROWDEDNESS9 NUMBER(1),
    CROWDEDNESS10 NUMBER(1),
    ...
    CONSTRAINT TRAIN_FK_PICTURE_1 FOREIGN KEY(PICTURE_ID1) REFERENCES INDOOR_PICTURE(ID),
    CONSTRAINT TRAIN_FK_PICTURE_2 FOREIGN KEY(PICTURE_ID2) REFERENCES INDOOR_PICTURE(ID),
    CONSTRAINT TRAIN_FK_PICTURE_3 FOREIGN KEY(PICTURE_ID3) REFERENCES INDOOR_PICTURE(ID),
    CONSTRAINT TRAIN_FK_PICTURE_4 FOREIGN KEY(PICTURE_ID4) REFERENCES INDOOR_PICTURE(ID),
    CONSTRAINT TRAIN_FK_PICTURE_5 FOREIGN KEY(PICTURE_ID5) REFERENCES INDOOR_PICTURE(ID),
    CONSTRAINT TRAIN_FK_PICTURE_6 FOREIGN KEY(PICTURE_ID6) REFERENCES INDOOR_PICTURE(ID),
    CONSTRAINT TRAIN_FK_PICTURE_7 FOREIGN KEY(PICTURE_ID7) REFERENCES INDOOR_PICTURE(ID),
    CONSTRAINT TRAIN_FK_PICTURE_8 FOREIGN KEY(PICTURE_ID8) REFERENCES INDOOR_PICTURE(ID),
    CONSTRAINT TRAIN_FK_PICTURE_9 FOREIGN KEY(PICTURE_ID9) REFERENCES INDOOR_PICTURE(ID),
    CONSTRAINT TRAIN_FK_PICTURE_10 FOREIGN KEY(PICTURE_ID10) REFERENCES INDOOR_PICTURE(ID)
);
